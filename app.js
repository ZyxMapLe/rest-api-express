...
app.post('/user/register', async(req, res) => {
	...
	var verificationUrl = "https://www.google.com/recaptcha/api/siteverify?secret=" + "6LfiUOIbAAAAACPdfXhAXESg_dQG5lcgWR0U7IOX" + "&response=" + req.body['g-recaptcha-response'] + "&remoteip=" + req.connection.remoteAddress;
