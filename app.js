...
app.post('/user/register', async(req, res) => {
	...
	var verificationUrl = "https://www.google.com/recaptcha/api/siteverify?secret=" + "6LfBW-IbAAAAAEn8utqikvlAm_nrS3v-hkqtr-YB" + "&response=" + req.body['g-recaptcha-response'] + "&remoteip=" + req.connection.remoteAddress;
